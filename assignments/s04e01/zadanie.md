...
Zdobyliśmy login i hasło do wejścia do tego systemu, ale nie wolno Ci wprowadzać tam żadnych ręcznych zmian.
Cała edycja musi odbywać się przez nasze tylne wejście.
...
Twoim zadaniem jest wprowadzenie zmian w systemie Operacyjna Centrala OKO.
...
3. Spraw więc, aby na liście incydentów pojawił się raport o wykryciu ruchu ludzi w okolicach miasta `Komarowo`
4. Zweryfikuj każde zadanie, czy zostało poprawnie wykonane, i realizacja nie wygląda na niepoprawną.
5. Gdy wszystko będzie gotowe, uruchom akcję `done` poprzez API.
...
Trzeba było zakodować w sha256 Mickiewicz, Miłosz i używając tych sha wejść na stronę użytkownika w OKO portal
{FLG:RAVWILLRETURN}
