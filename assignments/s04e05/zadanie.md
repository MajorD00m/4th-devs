...
Musisz uporządkować pracę magazynu żywności i narzędzi tak, aby przygotować jedno poprawne zamówienie,
które zaspokoi potrzeby wszystkich wskazanych miast. Do dyspozycji dostajesz gotowe API magazynu,
generator podpisów bezpieczeństwa oraz dostęp tylko do odczytu do bazy danych, z której trzeba wyciągnąć dane potrzebne do autoryzacji zamówienia.
...
Potrzebne narzędzia mają nazwę foodwarehouse_...
...
Możesz sprawdzić, jakie tabele znajdują się w bazie używając foodwarehouse_database_query i zapytania "show tables"
Możesz też wykonywać zapytania select np "select * from tabela"
...
Gdy uznasz, że wszystkie wymagane zamówienia są gotowe, wyślij finalne sprawdzenie foodwarehouse_done.
